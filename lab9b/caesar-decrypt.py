...
# s/i = eg Abobql rkcrpgf gur Fcnavfu vadhvfvgvba.
# abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ
# |                                                  |
# v v nopqrstuvwxyzabcdefghijklmNOPQRSTUVWXYZABCDEFGHIJKLM
# creat a cypher, using a
# dictionary to encrypt the input s/o = the cyphered line
